            ...
            <td>
                <select name="default_ccode" class="dig_inp_wid3 dig_inp_wid_wil">
                    ...
                    foreach ($countryList as $key => $value) {
                        ...
                        echo '<option class="dig-cc-visible" ' . $ac . ' value="' . $key . '" country="' . digits_strtolower($key) . '">' . $key . ' (+' . $value . ')</option>';
                    }
                    ?>
                </select>
            </td>
...
function digits_input_switch($name, $value)
{
    ...
    <div class="input-switch <?php echo $sel; ?>">
        ...
        <span class="status_text yes">بله</span>
        <span class="status_text no">خیر</span>
    </div>
