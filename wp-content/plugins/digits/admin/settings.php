...
function digit_admin_header_logo($show_update = true)
{
    ...
    <span class="dig-display_inline">
        ...
        <span class="digits_plugin_version">دیجیت فارسی : پیام یزدانیان</span>
        </a>
    </span>
    <?php
}
                ...
                <div class="dig_admin_left_side">
                    <div class="dig_admin_left_side_content">
                        ...
                        <div class="dig_sts_logo">
                           ...
                           <li><a class="dig_ngmc" href="https://support.digits-wp.ir/" target="_blank">سامانه پشتیبانی ویژه دیجیت فارسی</a></li>

                           <li><a class="dig_ngmc" href="https://digits-wp.ir" target="_blank">پشتیبان فارسی</a></li>
                        

						<li><a id="dig_activatetab" href="tg://resolve?domain=digits_wp" class="dig_ngmc updatetabview">کانال تلگرام</a></li>
