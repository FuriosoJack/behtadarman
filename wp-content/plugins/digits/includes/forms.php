                    ...
                    <div class="minput">
                        <div class="minput_inner">
                            <div class="digits-input-wrapper">
                                <label style="float: right;" ><?php echo $emailmob; ?></label>
                                <input type="text" style="width: 100%;"  class="mobile_field mobile_format dig-mobmail" placeholder="شماره موبایل یا ایمیل خود را وارد کنید"  name="mobmail"
...
<div class="forgotpasswordaContainer"><a class="forgotpassworda">رمز عبور خود را فراموش کرده اید؟</a></div>
	<?php } ?>

<input type="password" name="password" placeholder="رمز عبور خود را وارد کنید" required="" class="not-empty"><span class="bgdark"> </span>
        ...
        <div class="signupbutton transupbutton bgtransborderdark">کاربر جدید هستید؟
<span>در <?php bloginfo('name'); ?> ثبت نام کنید</span></div>
            ...
            <form accept-charset="utf-8" method="post" action="<?php echo $url; ?>" class="digits_forgot_pass">
                <div class="digits_fields_wrapper digits_forgot_pass_fields">
                    <div class="minput forgotpasscontainer">
                        <div class="minput_inner">
                            <label style="float: right;"><?php echo $emailmob; ?></label>
                            <div class="digits-input-wrapper">
                                <input class="mobile_field mobile_format forgotpass" placeholder="شماره موبایل یا ایمیل خود را وارد کنید" type="text" name="forgotmail"
                                       required/>
                            </div>
                ...
                <input type="hidden" name="digits_redirect_page"
                       value="<?php echo esc_attr($redirect_to); ?>"/>
                        ...
                        <div class="backtoLoginContainer"><a class="backtoLogin">برگشت به فرم ورود</a></div>
...
padding:10px;
                    ...
                    <div class="digits_fields_wrapper digits_register_fields">
                        ...
                        if ($nameaccep > 0) {
                            ...
                            <div id="dig_cs_name" class="minput">
                                <div class="minput_inner">
                                     <label style="float: right;"><?php _e("First Name", "digits"); ?></label>
                                    <div class="digits-input-wrapper">
                                        <input type="text" placeholder="نام خود را به فارسی وارد کنید"  name="digits_reg_name" class="digits_reg_name"
                        ...
                        if ($usernameaccep > 0) {
                            ...
                            <div id="dig_cs_username" class="minput">
                                <div class="minput_inner">
                                    <label style="float: right;" ><?php _e("Username", "digits"); ?></label>
                                    <div class="digits-input-wrapper">
                        ...
                        if ($emailaccep > 0 || $mobileaccp > 0) {
                            ...
                            <div id="dig_cs_mobilenumber" class="minput">
                                <div class="minput_inner">
                                    <label style="float:right;" ><?php if ($emailaccep == 2 && $mobileaccp == 2) {
                                            echo __('Mobile Number', 'digits');
                                        } else {
                                            echo $emailmob;
                                        } ?><?php echo $reqoropt; ?></label>
                                    <div class="digits-input-wrapper">
                                        <input type="text"  placeholder="شماره موبایل خود را وارد کنید"    class="mobile_field mobile_format digits_reg_email"
                        ...
                        if ($passaccep > 0) {
                            ...
                            <div id="dig_cs_password" class="minput" <?php if ($passaccep == 1) {
                                ...
                                <div class="minput_inner">
                                     <label style="float:right;"><?php _e("Password", "digits"); ?></label>
                                    <div class="digits-input-wrapper">
            ...
            <div class="backtoLoginContainer"><a class="backtoLogin">قبلا در <?php bloginfo('name'); ?> ثبت نام کرده اید؟ <span>وارد
                                                    شوید</span></a>
                </div>
