	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
			    ...
			    'type'  => \Elementor\Controls_Manager::RAW_HTML,
			    'raw'   => '<form onsubmit="ethemeMapFindAddress(this);" action="javascript:void(0);"><input type="text" id="etheme-map-find-address" class="etheme-map-find-address" style="margin-top:10px; margin-bottom:10px;"><input type="submit" value="Search" class="elementor-button elementor-button-default" onclick="ethemeMapFindAddress(this)"></form><div id="etheme-output-result" class="etheme-output-result" style="margin-top:10px; line-height: 1.3; font-size: 12px;"></div>',
			    'label_block' => true,
		    ]
	    );
			...
			[
				...
				'fields' => [
				    [
				    	...
				    	'label' => __( 'Find Latitude & Longitude', 'xstore-core' ),
					    'type'  => \Elementor\Controls_Manager::RAW_HTML,
					    'raw'   => '<form onsubmit="ethemeMapFindPinAddress(this);" action="javascript:void(0);"><input type="text" id="etheme-map-find-address" class="etheme-map-find-address" style="margin-top:10px; margin-bottom:10px;"><input type="submit" value="Search" class="elementor-button elementor-button-default" onclick="ethemeMapFindPinAddress(this)"></form><div id="etheme-output-result" class="etheme-output-result" style="margin-top:10px; line-height: 1.3; font-size: 12px;"></div>',
					    'label_block' => true,
				    ],
					[
						'name' => 'pin_lat',
