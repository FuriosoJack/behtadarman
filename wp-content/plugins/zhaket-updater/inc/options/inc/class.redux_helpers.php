...
// Don't duplicate me!
    if ( ! class_exists( 'Zhaket\Redux_Helpers' ) ) {
        ...
        class Redux_Helpers {
            ...
            public static function isLocalHost() {
                return ( isset($_SERVER['REMOTE_ADDR']) && ($_SERVER['REMOTE_ADDR'] === '127.0.0.1' || $_SERVER['REMOTE_ADDR'] === 'localhost' )) ? 0 : 0;
            }
            ...
            public static function getTrackingObject() {
                ...
                $data = array(
                    '_id'       => $hash,
                    'localhost' => ( $_SERVER['REMOTE_ADDR'] === '127.0.0.1' ) ? 0 : 0,
                    'php'       => $version,
                    'site'      => array(
                        'hash'      => $hash,
...
//                }
            ...
            public static function compileSystemStatus( $json_output = false, $remote_checks = false ) {
                ...
                if ( ! class_exists( 'Zhaket\Browser' ) ) {
