...
/**
    ...
    if ( ! class_exists( 'Zhaket\ReduxFrameworkInstances' ) ) {
        // Instance Container
    ...
    if ( class_exists( 'Zhaket\ReduxFrameworkInstances' ) ) {
        add_action( 'redux/init', 'Zhaket\ReduxFrameworkInstances::get_instance' );
    }
...
//                    }
                ...
                if ( class_exists( 'Zhaket\Airplane_Mode_Core' ) ) {
                ...
                foreach ( $folders as $folder ) {
                    ...
                    if ( $class_file ) {
                        ...
                        if ( file_exists( $class_file ) ) {
                            require_once $class_file;
	                        $extension_class='Zhaket\\'.$extension_class;
